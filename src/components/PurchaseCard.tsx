    ...
    <article className="card flex flex-col gap-2">
      ...
      {purchase.rating ? (
        ...
        >
          ...
          <span className="text-stone-300">{"★".repeat(5 - purchase.rating)}</span>
        </div>
      ) : null}
      <dl className="grid grid-cols-[auto_1fr] gap-x-2 gap-y-1 text-xs text-stone-600">
        ...
        {roast && (
          <>
            <dt className="text-stone-400">焙煎度</dt>
            <dd>{roast}</dd>
          </>
        )}
        {purchase.roastDate && (
          <>
            <dt className="text-stone-400">焙煎日</dt>
        ...
        {purchase.farm && (
          <>
            <dt className="text-stone-400">農園</dt>
            <dd>{purchase.farm}</dd>
          </>
        )}
        {purchase.altitude != null && (
          <>
            <dt className="text-stone-400">標高</dt>
